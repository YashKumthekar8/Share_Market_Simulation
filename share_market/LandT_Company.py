...
class LandTComp():
    ...
    def scrap_data(self):
        url = "https://moneybhai.moneycontrol.com/snapshot/stock-HDF01.html"
        r = requests.get(url)
        html = r.text
        ...
        link = 'https://www.moneycontrol.com/india/stockpricequote/infrastructure-general/larsentoubro/LT'
