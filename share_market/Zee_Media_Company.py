...
class Zee_MediaComp():
    ...
    def scrap_data(self):
        url = "https://moneybhai.moneycontrol.com/snapshot/stock-ZN.html"
        r = requests.get(url)
        html = r.text
        ...
        link = 'https://www.moneycontrol.com/india/stockpricequote/mediaentertainment/zeemediacorporation/ZN'
