...
class QuoteSpider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = ['https://moneybhai.moneycontrol.com/snapshot/stock-TCS.html']
    ...
    def plotGraph(self):
        ...
        try:
            ...
            print('Value Error')
        plt.fill_between(self.time_line, self.share_value_data, facecolor='pink', interpolate=True)
...
if __name__ == "__main__":
    subprocess.run("scrapy crawl TCS_shares", shell=True)
